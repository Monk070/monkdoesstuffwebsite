...
//
//   !<anything>  -> a guess at the current film (fuzzy, year optional)
//   !skip        -> vote to sharpen the frame one stage; passes when 25% of
//                   the current viewer count has voted. No effect once clear.
//
...
export class ChatController {
  ...
  handleEvent(msg) {
    ...
    const correct = guessMatches(guessText, round.movie);
