// TikTok chat moderation filter. If a film title contains a word viewers
// can't type in TikTok chat, they literally cannot guess it — so those films
...
// answer would be voting to advance the round instead — the film is unwinnable
...
export function collidesWithCommands(title) {
  ...
  return raw === 'skip' || normalize(title) === 'skip';
}
