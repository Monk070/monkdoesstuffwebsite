...
// bridge (/tiktok), which talks to TikTok LIVE directly via
// tiktok-live-connector — no TikFinity needed. Auto-reconnects with
// exponential backoff (1s → 15s).
//
// Events arrive as { event, data } in TikFinity-compatible shapes:
//   chat        { uniqueId, nickname, comment, profilePictureUrl }
//   like        { uniqueId, nickname, likeCount }
//   gift        { uniqueId, nickname, giftName, diamondCount, repeatCount, repeatEnd }
//   member      { uniqueId, nickname }
